...
%TODO: adhv afbeeldingen tonen
Hoofdscherm $\leftrightarrow$ Detailscherm
\begin{itemize}[label={$\rightarrow$}]
    \item SQL Server databank.
    \item MailTimerHelper (traditionele web app)
    \item PingHost extensie.
\end{itemize}
