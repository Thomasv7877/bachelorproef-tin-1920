...
De marktleidende low-code paltformen gefocust op professionele ontwikkelaars zijn duurder van de concurrentie. Mendix en Outsystems rekenen meer dan \euro2000 voor hun basis plan (Zie Tabel \ref{tab:price-outsystems} en \ref{tab:price-mendix}). Het was daarom belangrijk dat de POC binnen de limieten bleef, de meerprijs zou niet worden aanvaard.
...
In Subsectie~\ref{subsec:os-prijs} wordt een beeld gemaakt van de beperkingen. Vooral de punten ove rgedeelde resources en 'in slaap gaan' van de omgeving zijn reelvant tov performantie. PowerApps kent deze beperkingen niet. Dit is natuurlijk te verwachten als een gratis plan (Outsystems) vergeleken wordt met een betalend plan (PowerApps).\\
...
Alvorens er data opgevraagd kan worden moet het authenticatie proces (hier OAuth V2) doorlopen worden (Figuur~\ref{fig:auth-proces}).

\begin{figure}[h!]
    \centering
    \includegraphics[width=\linewidth]{auth-proces.png}
    \caption{Weergave van het authenticatie proces. \autocite{MSLCT2019}}
...
Dit is mogelijk via het officiele Forge Component van Outsystems\footnote{\url{https://www.outsystems.com/forge/component-overview/1403/barcode-plugin}}.\\
